...
export function CheckoutOrderSummary({
  ...
  return (
    <>
          ...
          {isMobileDrawerOpen && (
            <div className="px-4 pb-4 pt-2 bg-[#FAF6F1] border-t border-[#2B2420]/10 animate-in fade-in duration-200">
              ...
              <div className="flex flex-col gap-3 pt-1">
                {items.map((item, idx) => (
                  <div key={item.id} className="flex gap-3 py-2 border-b border-[#2B2420]/10 last:border-b-0">
              ...
              <div className="mt-3 p-3 bg-[#FFF1EA] flex flex-col gap-1.5 font-sans text-xs border border-[#2B2420]/10">
                ...
                {isPromoApplied && (
                  <div className="flex items-center justify-between text-[#5C5A3E] font-semibold">
                    <span>Atelier Privilege Voucher</span>
                    <span>-$20.00</span>
                  </div>
                )}
      ...
      <section className="hidden lg:flex bg-[#FFF1EA] p-8 flex-col gap-6 sticky top-28 border border-[#2B2420]/10 shadow-xs">
        {/* Summary Header */}
