  ...
  return (
    <div className="flex flex-col space-y-6 md:space-y-8">
      ...
      <div className="flex md:hidden flex-col space-y-6">
        {/* 03 / Delivery & Payment Combined Card */}
        <section aria-label="Logistics and Payment Data">
          ...
          <div className="bg-[#FFF1EA] p-4 shadow-xs border border-[#2B2420]/10 flex flex-col gap-3.5">
            {/* Delivery Details */}
            <div>
              <span className="font-sans text-[10px] uppercase tracking-[0.16em] text-[#53433F] font-semibold block mb-1">
                Dispatch Destination
              </span>
              <p className="font-sans text-sm text-[#211A16] font-medium leading-snug">
                {order.customer.firstName} {order.customer.lastName}
              </p>
              <p className="font-sans text-xs text-[#53433F] leading-relaxed mt-0.5">
              ...
              <div className="mt-2 inline-flex items-center gap-1.5 px-2 py-0.5 bg-[#F3E5DF] text-[#53433F] text-[11px] font-sans uppercase tracking-widest font-medium border border-[#2B2420]/5">
            ...
            {/* Payment Details */}
            <div className="bg-[#F9EBE5] p-2.5 flex items-center justify-between border border-[#2B2420]/10">
              <div className="flex items-center gap-2">
                <CreditCard className="w-4 h-4 text-[#894B37]" />
                <div className="flex flex-col">
                  <span className="font-sans text-[10px] uppercase tracking-wider text-[#53433F] font-semibold">
                    Method
                  </span>
                  <span className="font-sans text-xs text-[#211A16]">
                    {order.payment.method === "upi"
                      ? `UPI: ${order.payment.upiId || "client@okhdfcbank"}`
                      : order.payment.method === "cod"
                      ? "Payable upon delivery"
                      : `Card ending in ${order.payment.cardLast4 || "4821"}`}
                  </span>
                </div>
              </div>
              <span className="font-sans text-[10px] bg-[#E5E1BD] text-[#666447] px-2 py-0.5 uppercase tracking-wider font-semibold">
                Settled
              </span>
            </div>
          </div>
        ...
        {/* 04 / Protocol — What Happens Next */}
        <section aria-label="Post-Purchase Steps">
          <div className="bg-[#F9EBE5] p-4 shadow-xs border border-[#2B2420]/10">
            <span className="font-sans text-[11px] uppercase tracking-[0.2em] text-[#894B37] font-semibold block mb-1">
              04 / Protocol
            </span>
            <h3 className="font-serif text-xl text-[#211A16] mb-3 font-normal">
              What Happens Next
            </h3>
            <div className="flex flex-col gap-3 font-sans text-xs">
              <div className="flex gap-2.5 items-start">
                <span className="font-mono text-xs text-[#894B37] font-bold pt-0.5">
                  01
                </span>
                <div>
                  <h4 className="font-sans text-xs uppercase tracking-wider text-[#211A16] font-semibold">
                    Order Confirmed
                  </h4>
                  <p className="text-[#53433F] text-xs leading-relaxed mt-0.5">
                    Your selection is registered in our private atelier repository.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2.5 items-start">
                ...
                <div>
                  ...
                  <p className="text-[#53433F] text-xs leading-relaxed mt-0.5">
                    Inspected carefully and hand-wrapped in unbleached archive tissue.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-2.5 items-start">
                ...
                <div>
                  ...
                  <p className="text-[#53433F] text-xs leading-relaxed mt-0.5">
                    Tracking notification and courier handover dispatch transmitted via email.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section aria-label="Action Controls" className="pt-1 pb-4 flex flex-col gap-2.5">
          <Link
            href="/shop"
            className="w-full h-12 bg-[#211A16] text-[#FCEEE7] font-sans text-xs uppercase tracking-[0.16em] flex items-center justify-center gap-2 hover:bg-[#894B37] transition-colors shadow-xs font-semibold"
          >
          ...
          <button
            ...
            className="w-full py-2 text-center font-sans text-[11px] uppercase tracking-[0.2em] text-[#211A16] hover:text-[#894B37] transition-colors cursor-pointer"
          >
            Save Confirmation Summary — PDF
          </button>
          {showToast && (
            <div className="text-center text-[#894B37] font-sans text-xs py-2 bg-[#FFDBD0]/40 border border-[#894B37]/20 animate-pulse">
              Receipt index copied to personal archive.
            </div>
          )}
        </section>
      </div>
